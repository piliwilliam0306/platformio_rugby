...
env.Replace(
        SETFUSECMD='$UPLOADER $UPLOADERFLAGS -e -P $UPLOAD_PORT -b $UPLOAD_SPEED -Ulock:w:0x3F:m -Uefuse:w:0xfd:m -Uhfuse:w:0xDA:m -Ulfuse:w:0xff:m',
...
bootloader_path = "ATmegaBOOT_168_atmega328.hex"
